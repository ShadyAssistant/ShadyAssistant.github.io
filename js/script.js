...
/*================================================================= 
    Map
==================================================================*/
if( document.querySelector('#mapwrapper') ) {
	var map = L.map('mapwrapper').setView([-7.23630731881245, 112.74953335490126], 12);
	...
	L.marker([-7.23630731881245, 112.74953335490126], {icon: greenIcon}).addTo(map);
}
